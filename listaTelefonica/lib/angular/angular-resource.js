 ...
 *
 * ```js
     app.value(['$resourceProvider', function($resourceProvider) {
 ...
 *   extended.
 *
 *   The declaration should be created in the format of {@link ng.$http#usage $http.value}:
 *
 ...
 *     **Note:** In contrast to {@link ng.$http#usage $http.value}, {@link ng.$q promises} are
...
angular.module('ngResource', ['ng']).
  ...
  provider('$resource', function ResourceProvider() {
     ...
     *   angular.
     *     module('myApp').
     *     value(['$resourceProvider', function ($resourceProvider) {
